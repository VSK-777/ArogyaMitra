...
- **Primary Reassignment:** The \utoReschedule\ algorithm first attempts to reassign the patient to a different available doctor within the *same department* on the *same day*. If successful, the appointment status becomes \REASSIGNED\ and a new token is generated.
